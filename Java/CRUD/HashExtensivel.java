...
- long read(T elemento)        // apenas o identificador precisa estar preenchido
- boolean update(T elemento)
- boolean delete(T elemento)   // apenas o identificador precisa estar preenchido
...
public class HashExtensivel<T extends RegistroHashExtensivel<T>> {
    ...
    public HashExtensivel(Constructor<T> construtor, int quantidadeDadosPorCesto, String nomeArquivo) throws Exception {
        this.construtor = construtor;
        this.quantidadeDadosPorCesto = quantidadeDadosPorCesto;
        this.nomeArquivoDiretorio = nomeArquivo + "_d.db";
        this.nomeArquivoCestos = nomeArquivo + "_c.db";
